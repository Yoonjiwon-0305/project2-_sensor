...
HD_PWD='C:/Ondevice/sr04_test/sr04_test/sr04_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_sr04_fnd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_sr04_fnd.tcl
