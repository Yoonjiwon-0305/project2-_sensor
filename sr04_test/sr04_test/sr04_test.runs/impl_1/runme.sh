...
HD_PWD='C:/Ondevice/sr04_test/sr04_test/sr04_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_sr04_fnd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_sr04_fnd.tcl -notrace
